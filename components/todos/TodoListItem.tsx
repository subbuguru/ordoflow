...
export function TodoListItem({
  ...
  return <Animated.View style={rCompleteStyle}>
        ...
        <GestureDetector gesture={panGesture}>
          <Animated.View style={rSwipeStyle}>
            <Pressable style={styles.todoRow} onPress={() => onStartEdit(item)}>
              <TouchableOpacity onPress={handleToggleComplete} hitSlop={{
              top: 10,
              bottom: 10,
              left: 10,
              right: 10
            }}>
                <View style={[styles.circle, !isComplete && item.priority === "p1" && styles.circleP1, !isComplete && item.priority === "p2" && styles.circleP2, !isComplete && item.priority === "p3" && styles.circleP3, !isComplete && item.priority === "p4" && styles.circleP4, isComplete && item.priority === "p1" && styles.circleCompletedP1, isComplete && item.priority === "p2" && styles.circleCompletedP2, isComplete && item.priority === "p3" && styles.circleCompletedP3, isComplete && item.priority === "p4" && styles.circleCompletedP4]}>
              ...
              {onDrag && <TouchableOpacity onPressIn={handleDragPress} style={[styles.dragHandle, isActive && styles.dragHandleActive]} hitSlop={{
              top: 20,
              bottom: 20,
              left: 30,
              right: 30
            }}>
                  <Ionicons name="reorder-three-outline" size={28} color={colors.textSecondary} />
                </TouchableOpacity>}
            </Pressable>
          </Animated.View>
        </GestureDetector>
