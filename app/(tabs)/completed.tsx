...
export default function Completed() {
  ...
  const confirmDeleteAll = () => {
    ...
    Alert.alert("Delete All Completed?", "Are you sure you want to delete all completed tasks? This cannot be undone.", [{
      text: "Cancel",
      style: "cancel"
    }, {
      text: "Delete All",
  ...
  return <View style={styles.container}>
      <View style={styles.headerRow}>
        ...
        {completedTodos.length > 0 && <TouchableOpacity onPress={showHeaderMenu} style={styles.menuBtn}>
            <Ionicons name="ellipsis-horizontal-outline" size={26} color={colors.tint} />
          </TouchableOpacity>}
      </View>

      <TodoList todos={completedTodos} onToggleComplete={toggleTodoCompleted} onDelete={deleteTodo} onStartEdit={() => {}} onReload={reload} emptyMessage="No completed tasks yet." />
    </View>;
}
